...
\begin{figure}[ht]
	\centering
	\includegraphics[width=10cm,height=6.2cm]{Ulearning.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=17cm,height=11cm]{OperaSnapshot.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=13cm,height=10cm]{FGH.png}
