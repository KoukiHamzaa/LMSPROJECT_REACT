...
\begin{figure}[ht]
	\centering
	\includegraphics[width=13cm,height=7cm]{DiagrammeCom.jpg}
	\caption{Section de chapitre .}
	\label{fig:Section de chapitre }
\end{figure}
\FloatBarrier
\clearpage
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=8cm,height=5cm]{PackageDiagram1.jpg}
