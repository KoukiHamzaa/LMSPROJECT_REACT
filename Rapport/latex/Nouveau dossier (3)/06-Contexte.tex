...
\begin{figure}[ht]
	\centering
	\includegraphics[width=10cm,height=6cm]{Sanstllitre1.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=14cm,height=8.5cm]{RôlesScrum.jpg}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=14cm,height=8.5cm]{LesévènementsScrum.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[height=15cm,width=17cm]{gantt.PNG}
